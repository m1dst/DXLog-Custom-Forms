...
namespace DXLog.net
{
    public partial class OperatorStatistics : KForm
    {
        public static string CusWinName => "Operator Statistics";
        public static int CusFormID => 20220905;
        ...
        {
            var groupByOperatorQuery =
                from qso in _contestData.QSOList
                where !qso.InvalidQSO
                group qso by qso.Operator into newGroup
            ...
            {
                chart1.Series["Operator"].Points.Clear();
                foreach (var nameGroup in groupByOperatorQuery)
                {
                    var operatorCallsign = !string.IsNullOrEmpty(nameGroup.Key) ? nameGroup.Key : "UNKNOWN";
                    chart1.Series["Operator"].Points.AddXY(operatorCallsign, nameGroup.Count());
                }
            }
        ...
        public override void InitializeLayout()
        {
            ...
            chart1.Series[0].Color = getColorByType("Bar");
            chart1.Series[0].LabelBackColor = getColorByType("Label Background");
            chart1.Series[0].LabelForeColor = getColorByType("Label");
